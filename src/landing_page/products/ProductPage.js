...
function ProductPage() {
  return (
    <>
      ...
      <RightSection imageUrl="/media/images/console.png" productName="Console" productDescription="A powerful reporting and analytics platform that helps you track, analyze, and optimize your investments. Access your portfolio performance and other insights on the go with our mobile app."  />
